...
<nav class="bg-white border-b border-gray-200 px-4 py-3">
    <div class="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div class="hidden md:flex items-center gap-1">
            ...
            <a href="<?= $in_subdir ? 'interval_builder.php' : 'activity/interval_builder.php' ?>" class="px-3 py-2 text-sm rounded-lg transition-colors <?= $current_page === 'interval_builder.php' ? 'text-[#fc5200] bg-[#fc5200]/10' : 'text-[#9CA3AF] hover:text-[#fc5200] hover:bg-gray-50' ?>">Interval</a>
